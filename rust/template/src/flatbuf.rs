...
impl <'b> ToFlatBuffer<'b> for bool {
    ...
    fn to_flatbuf(&self, _fbb: &mut fbrt::FlatBufferBuilder<'b>) -> Self::Target { *self }
}
...
impl <'b> ToFlatBuffer<'b> for u128
{
    ...
    fn to_flatbuf(&self, fbb: &mut fbrt::FlatBufferBuilder<'b>) -> Self::Target {
        ...
        fb::__BigUint::create(fbb, &fb::__BigUintArgs{
            bytes: Some(vec)
        })
    }
}
...
impl <'b> ToFlatBuffer<'b> for i128
{
    ...
    fn to_flatbuf(&self, fbb: &mut fbrt::FlatBufferBuilder<'b>) -> Self::Target {
        ...
        fb::__BigInt::create(fbb, &fb::__BigIntArgs{
            sign: *self >= 0,
            bytes: Some(vec)
        })
    }
...
V: ToFlatBuffer<'b, Target=(fb::__Value, fbrt::WIPOffset<fbrt::UnionWIPOffset>)>
{
    ...
    fn to_flatbuf(&self, fbb: &mut fbrt::FlatBufferBuilder<'b>) -> Self::Target {
        ...
        fb::__Command::create(fbb, &fb::__CommandArgs{
            kind: if self.2 { fb::__CommandKind::Insert } else { fb::__CommandKind::Delete },
            relid: self.0 as u64,
            val_type,
            val: Some(v),
        })
...
pub fn updates_to_flatbuf(delta: &DeltaMap) -> (Vec<u8>, usize)
{
    ...
    let cmd_table = fb::__Commands::create(&mut fbb, &fb::__CommandsArgs{
