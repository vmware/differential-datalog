    ...
    public void testWeave() {
        ...
        */
        ...
        String expected = "import sql\nimport sqlop\n" + "\n" +
                ...
                "typedef Ttmp2 = Ttmp2{pod_name:string, status:string, controllable__node_name:Option<string>, namespace:string, cpu_request:bigint, memory_request:bigint, ephemeral_storage_request:bigint, pods_request:bigint, owner_name:string, creation_timestamp:string, has_node_selector_labels:bool, has_pod_affinity_requirements:bool, pod_name0:string, term:signed<64>, match_expression:signed<64>, num_match_expressions:signed<64>, label_key:string, label_operator:string, label_value:Option<string>}\n" +
                ...
                "typedef Ttmp5 = Ttmp5{pod_name:string, status:string, controllable__node_name:Option<string>, namespace:string, cpu_request:bigint, memory_request:bigint, ephemeral_storage_request:bigint, pods_request:bigint, owner_name:string, creation_timestamp:string, has_node_selector_labels:bool, has_pod_affinity_requirements:bool, pod_name0:string, label_selector:signed<64>, match_expression:signed<64>, num_match_expressions:signed<64>, label_key:string, label_operator:string, label_value:string, topology_key:string}\n" +
                "typedef Ttmp6 = Ttmp6{pod_name:string, status:string, controllable__node_name:Option<string>, namespace:string, cpu_request:bigint, memory_request:bigint, ephemeral_storage_request:bigint, pods_request:bigint, owner_name:string, creation_timestamp:string, has_node_selector_labels:bool, has_pod_affinity_requirements:bool, pod_name0:string, label_selector:signed<64>, match_expression:signed<64>, num_match_expressions:signed<64>, label_key:string, label_operator:string, label_value:string, topology_key:string, pod_name1:string, label_key0:string, label_value0:string}\n" +
                "typedef Ttmp7 = Ttmp7{pod_name:string, status:string, controllable__node_name:Option<string>, namespace:string, cpu_request:bigint, memory_request:bigint, ephemeral_storage_request:bigint, pods_request:bigint, owner_name:string, creation_timestamp:string, has_node_selector_labels:bool, has_pod_affinity_requirements:bool, pod_name0:string, label_selector:signed<64>, match_expression:signed<64>, num_match_expressions:signed<64>, label_key:string, label_operator:string, label_value:string, topology_key:string, pod_name1:string, label_key0:string, label_value0:string, pod_name2:string, status0:string, node_name:Option<string>, namespace0:string, cpu_request0:bigint, memory_request0:bigint, ephemeral_storage_request0:bigint, pods_request0:bigint, owner_name0:string, creation_timestamp0:string, priority:signed<64>, schedulerName:Option<string>, has_node_selector_labels0:bool, has_pod_affinity_requirements0:bool}\n" +
                "typedef TRtmp8 = TRtmp8{pod_name:string, matches:string, node_name:Option<string>}\n" +
                "typedef Tagg9 = Tagg9{col:bool}\n" +
                "typedef Ttmp10 = Ttmp10{name:string, unschedulable:bool, out_of_disk:bool, memory_pressure:bool, disk_pressure:bool, pid_pressure:bool, ready:bool, network_unavailable:bool, cpu_capacity:bigint, memory_capacity:bigint, ephemeral_storage_capacity:bigint, pods_capacity:bigint, cpu_allocatable:bigint, memory_allocatable:bigint, ephemeral_storage_allocatable:bigint, pods_allocatable:bigint, pod_name:string, status:string, node_name:Option<string>, namespace:string, cpu_request:bigint, memory_request:bigint, ephemeral_storage_request:bigint, pods_request:bigint, owner_name:string, creation_timestamp:string, priority:signed<64>, schedulerName:Option<string>, has_node_selector_labels:bool, has_pod_affinity_requirements:bool}\n" +
                ...
                "Rpod_node_selector_matches[v12] :- Rpods_to_assign[v],Rpod_node_selector_labels[v0],(v.pod_name == v0.pod_name),true,var v1 = Ttmp2{.pod_name = v.pod_name,.status = v.status,.controllable__node_name = v.controllable__node_name,.namespace = v.namespace,.cpu_request = v.cpu_request,.memory_request = v.memory_request,.ephemeral_storage_request = v.ephemeral_storage_request,.pods_request = v.pods_request,.owner_name = v.owner_name,.creation_timestamp = v.creation_timestamp,.has_node_selector_labels = v.has_node_selector_labels,.has_pod_affinity_requirements = v.has_pod_affinity_requirements,.pod_name0 = v0.pod_name,.term = v0.term,.match_expression = v0.match_expression,.num_match_expressions = v0.num_match_expressions,.label_key = v0.label_key,.label_operator = v0.label_operator,.label_value = v0.label_value},Rnode_labels[v2],unwrapBool(b_or_NR(b_or_NR(b_or_NR(b_and_RN(((v0.label_operator == \"In\") and (v0.label_key == v2.label_key)), s_eq_NR(v0.label_value, v2.label_value)), ((v0.label_operator == \"Exists\") and (v0.label_key == v2.label_key))), (v0.label_operator == \"NotIn\")), (v0.label_operator == \"DoesNotExist\"))),true,var v3 = Ttmp3{.pod_name = v1.pod_name,.status = v1.status,.controllable__node_name = v1.controllable__node_name,.namespace = v1.namespace,.cpu_request = v1.cpu_request,.memory_request = v1.memory_request,.ephemeral_storage_request = v1.ephemeral_storage_request,.pods_request = v1.pods_request,.owner_name = v1.owner_name,.creation_timestamp = v1.creation_timestamp,.has_node_selector_labels = v1.has_node_selector_labels,.has_pod_affinity_requirements = v1.has_pod_affinity_requirements,.pod_name0 = v1.pod_name0,.term = v1.term,.match_expression = v1.match_expression,.num_match_expressions = v1.num_match_expressions,.label_key = v1.label_key,.label_operator = v1.label_operator,.label_value = v1.label_value,.node_name = v2.node_name,.label_key0 = v2.label_key,.label_value0 = v2.label_value},var gb = v.pod_name,var gb4 = v2.node_name,var gb5 = v0.term,var gb6 = v0.label_operator,var gb7 = v0.num_match_expressions,var aggResult = Aggregate((gb, gb4, gb5, gb6, gb7), agg((v, v0, v2))),var v11 = TRtmp4{.pod_name = gb,.node_name = gb4,.col = aggResult.col},if (gb6 == \"NotIn\") {\n" +
                "(not any_N(b_and_RN((v0.label_key == v2.label_key), s_eq_NR(v0.label_value, v2.label_value))))} else {\n" +
                "if (gb6 == \"DoesNotExist\") {\n" +
                "(not any((v0.label_key == v2.label_key)))} else {\n" +
                "(count_distinct(v0.match_expression) == gb7)}},var v12 = v11.\n" +
                "Rinter_pod_affinity_matches_inner[v16] :- Rpods_to_assign[v],Rpod_affinity_match_expressions[v0],(v.pod_name == v0.pod_name),true,var v1 = Ttmp5{.pod_name = v.pod_name,.status = v.status,.controllable__node_name = v.controllable__node_name,.namespace = v.namespace,.cpu_request = v.cpu_request,.memory_request = v.memory_request,.ephemeral_storage_request = v.ephemeral_storage_request,.pods_request = v.pods_request,.owner_name = v.owner_name,.creation_timestamp = v.creation_timestamp,.has_node_selector_labels = v.has_node_selector_labels,.has_pod_affinity_requirements = v.has_pod_affinity_requirements,.pod_name0 = v0.pod_name,.label_selector = v0.label_selector,.match_expression = v0.match_expression,.num_match_expressions = v0.num_match_expressions,.label_key = v0.label_key,.label_operator = v0.label_operator,.label_value = v0.label_value,.topology_key = v0.topology_key},Rpod_labels[v2],((((((v0.label_operator == \"In\") and (v0.label_key == v2.label_key)) and (v0.label_value == v2.label_value)) or ((v0.label_operator == \"Exists\") and (v0.label_key == v2.label_key))) or (v0.label_operator == \"NotIn\")) or (v0.label_operator == \"DoesNotExist\")),true,var v3 = Ttmp6{.pod_name = v1.pod_name,.status = v1.status,.controllable__node_name = v1.controllable__node_name,.namespace = v1.namespace,.cpu_request = v1.cpu_request,.memory_request = v1.memory_request,.ephemeral_storage_request = v1.ephemeral_storage_request,.pods_request = v1.pods_request,.owner_name = v1.owner_name,.creation_timestamp = v1.creation_timestamp,.has_node_selector_labels = v1.has_node_selector_labels,.has_pod_affinity_requirements = v1.has_pod_affinity_requirements,.pod_name0 = v1.pod_name0,.label_selector = v1.label_selector,.match_expression = v1.match_expression,.num_match_expressions = v1.num_match_expressions,.label_key = v1.label_key,.label_operator = v1.label_operator,.label_value = v1.label_value,.topology_key = v1.topology_key,.pod_name1 = v2.pod_name,.label_key0 = v2.label_key,.label_value0 = v2.label_value},Rpod_info[v4],(v2.pod_name == v4.pod_name),true,var v5 = Ttmp7{.pod_name = v3.pod_name,.status = v3.status,.controllable__node_name = v3.controllable__node_name,.namespace = v3.namespace,.cpu_request = v3.cpu_request,.memory_request = v3.memory_request,.ephemeral_storage_request = v3.ephemeral_storage_request,.pods_request = v3.pods_request,.owner_name = v3.owner_name,.creation_timestamp = v3.creation_timestamp,.has_node_selector_labels = v3.has_node_selector_labels,.has_pod_affinity_requirements = v3.has_pod_affinity_requirements,.pod_name0 = v3.pod_name0,.label_selector = v3.label_selector,.match_expression = v3.match_expression,.num_match_expressions = v3.num_match_expressions,.label_key = v3.label_key,.label_operator = v3.label_operator,.label_value = v3.label_value,.topology_key = v3.topology_key,.pod_name1 = v3.pod_name1,.label_key0 = v3.label_key0,.label_value0 = v3.label_value0,.pod_name2 = v4.pod_name,.status0 = v4.status,.node_name = v4.node_name,.namespace0 = v4.namespace,.cpu_request0 = v4.cpu_request,.memory_request0 = v4.memory_request,.ephemeral_storage_request0 = v4.ephemeral_storage_request,.pods_request0 = v4.pods_request,.owner_name0 = v4.owner_name,.creation_timestamp0 = v4.creation_timestamp,.priority = v4.priority,.schedulerName = v4.schedulerName,.has_node_selector_labels0 = v4.has_node_selector_labels,.has_pod_affinity_requirements0 = v4.has_pod_affinity_requirements},var gb = v.pod_name,var gb6 = v2.pod_name,var gb7 = v0.label_selector,var gb8 = v0.topology_key,var gb9 = v0.label_operator,var gb10 = v0.num_match_expressions,var gb11 = v4.node_name,var aggResult = Aggregate((gb, gb6, gb7, gb8, gb9, gb10, gb11), agg9((v, v0, v2, v4))),var v15 = TRtmp8{.pod_name = gb,.matches = gb6,.node_name = gb11,.col = aggResult.col},if (gb9 == \"NotIn\") {\n" +
                "(not any(((v0.label_key == v2.label_key) and (v0.label_value == v2.label_value))))} else {\n" +
                "if (gb9 == \"DoesNotExist\") {\n" +
                "(not any((v0.label_key == v2.label_key)))} else {\n" +
                "(count_distinct(v0.match_expression) == gb10)}},var v16 = v15.\n" +
