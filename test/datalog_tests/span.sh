...
gcc -shared -Wl,-soname,ddlogapi -fPIC -I${JAVA_HOME}/include -I${JAVA_HOME}/include/linux -I../../rust/template ../java_call/ddlogapi.c ../java_call/ddlogapi_DDLogAPI.h -Lspan_ddlog/target/release/ -lspan_ddlog -o libddlogapi.so
